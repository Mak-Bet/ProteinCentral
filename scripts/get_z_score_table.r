...
output_file_path <- file.path(base_path, "z_scores_centrality_measures.tsv")
...
# Construct the file path for the merged TSV file
merged_file_path <- file.path(base_path, "sep2_merged_centrality_measures.tsv")
...
# Construct the file path for the output TSV file
output_file_path <- file.path(base_path, "sep2_z_scores_centrality_measures.tsv")
