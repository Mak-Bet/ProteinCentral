...
# Construct file paths
file1_path <- file.path(base_path, "sep2_dist_based_centrality_measures.tsv")
file2_path <- file.path(base_path, "sep2_tes_based_centrality_measures.tsv")
...
# Write the merged dataframe to a new TSV file in the same directory
output_file_path <- file.path(base_path, "sep2_merged_centrality_measures.tsv")
write.table(merged_data, output_file_path, sep = "\t", row.names = FALSE, quote = FALSE)
